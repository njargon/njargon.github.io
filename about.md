...
- 基本的にはpcやタブレットでの表示が推奨です。
	- スマホだと、見出しがなかったり、工事中の時の対応が後回しになったりします。
- 不定期更新です。
	- しばらくは一週間ぐらいごとに練習とか落書きのあたりを更新する予定です。
- タイトル
	- 記事を書いたときに「きじが脱走しました」(記事が脱稿しました)って言いたかっただけです。(しょうもない)
- ホームバナーの写真
...
- 言語のお話をしたくなる時があります。
	- 特に通時変化や音韻音声に興味があります。
- たいしたものは上げてないですが、もしちょっとでも興味を持ってくれた方がいれば、  
SNSで気軽に話しかけてもらえると嬉しいです。
